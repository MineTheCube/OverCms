...
$content = '
<link href="' . $http_path . 'assets/animate.css" type="text/css" rel="stylesheet" />
<style>
.carousel .item {
    left: 0 !important;
...
<div id="carousel-main" class="carousel slide" data-ride="carousel" data-interval="8000">
  ...
  <div class="carousel-inner">
    <div class="item active" style="background-image: url(\'' . $http_path . 'img/' . '1' .'.jpg' . '\');">
    ...
    <div class="item" style="background-image: url(\'' . $http_path . 'img/' . '2' .'.jpg' . '\');">
      <div class="carousel-caption">
    ...
    <div class="item" style="background-image: url(\'' . $http_path . 'img/' . '7' .'.jpg' . '\');">
