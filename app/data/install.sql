...
INSERT INTO "cms_pages" ("id", "title", "slug", "home", "is_parent", "parent_id", "p_view", "p_edit", "content", "type", "type_data", "state", "header", "header_data", "position") VALUES (1,	'Accueil',	'accueil',	1,	'0',	'0',	'0',	'0',	'<div>
    <h2>Bienvenue !</h2>
    <br>
...
</div>',	'custom',	'',	'0',	'bootstrap_carousel',	'',	'0');
INSERT INTO "cms_pages" ("id", "title", "slug", "home", "is_parent", "parent_id", "p_view", "p_edit", "content", "type", "type_data", "state", "header", "header_data", "position") VALUES (2,	'Erreur',	'erreur',	'0',	'0',	'0',	'0',	'0',	'Une erreur est survenue..',	'native',	'error',	1,	'simple_header',	'{"desc": "Tout ne s''est pas passé comme prévu.."}',	'0');
INSERT INTO "cms_pages" ("id", "title", "slug", "home", "is_parent", "parent_id", "p_view", "p_edit", "content", "type", "type_data", "state", "header", "header_data", "position") VALUES (3,	'Connexion',	'connexion',	'0',	'0',	'0',	'0',	'0',	'',	'native',	'login',	1,	'simple_header',	'',	'0');
INSERT INTO "cms_pages" ("id", "title", "slug", "home", "is_parent", "parent_id", "p_view", "p_edit", "content", "type", "type_data", "state", "header", "header_data", "position") VALUES (4,	'Mot de passe oublié',	'mot-de-passe-oublie',	'0',	'0',	'0',	'0',	'0',	'',	'native',	'recovery',	1,	'simple_header',	'',	'0');
INSERT INTO "cms_pages" ("id", "title", "slug", "home", "is_parent", "parent_id", "p_view", "p_edit", "content", "type", "type_data", "state", "header", "header_data", "position") VALUES (5,	'Inscription',	'inscription',	'0',	'0',	'0',	'0',	'0',	'',	'native',	'register',	1,	'simple_header',	'',	'0');
INSERT INTO "cms_pages" ("id", "title", "slug", "home", "is_parent", "parent_id", "p_view", "p_edit", "content", "type", "type_data", "state", "header", "header_data", "position") VALUES (6,	'Mon compte',	'mon-compte',	'0',	'0',	'0',	1,	'0',	'',	'native',	'account',	1,	'simple_header',	'',	'0');
INSERT INTO "cms_pages" ("id", "title", "slug", "home", "is_parent", "parent_id", "p_view", "p_edit", "content", "type", "type_data", "state", "header", "header_data", "position") VALUES (7,	'Espace membre',	'membre',	'0',	'0',	'0',	'0',	'0',	'',	'native',	'member',	1,	'simple_header',	'',	'0');
INSERT INTO "cms_pages" ("id", "title", "slug", "home", "is_parent", "parent_id", "p_view", "p_edit", "content", "type", "type_data", "state", "header", "header_data", "position") VALUES (8,	'Déconnexion',	'deconnexion',	'0',	'0',	'0',	1,	'0',	'',	'native',	'logout',	1,	'simple_header',	'',	4);
INSERT INTO "cms_pages" ("id", "title", "slug", "home", "is_parent", "parent_id", "p_view", "p_edit", "content", "type", "type_data", "state", "header", "header_data", "position") VALUES (11,	'Membres du staff',	'membres-du-staff',	'0',	1,	'0',	'0',	'0',	'',	'custom',	'',	'0',	'',	'',	1);
INSERT INTO "cms_pages" ("id", "title", "slug", "home", "is_parent", "parent_id", "p_view", "p_edit", "content", "type", "type_data", "state", "header", "header_data", "position") VALUES (12,	'Admins',	'admins',	'0',	'0',	11,	'0',	'0',	'<div>
...
</div>',	'custom',	'',	'0',	'simple_header',	'{"desc": "Ceux qui dirigent tout !"}',	1);
INSERT INTO "cms_pages" ("id", "title", "slug", "home", "is_parent", "parent_id", "p_view", "p_edit", "content", "type", "type_data", "state", "header", "header_data", "position") VALUES (13,	'Modérateurs',	'moderateurs',	'0',	'0',	11,	'0',	'0',	'<div>
...
</div>',	'custom',	'',	'0',	'simple_header',	'{"desc": "Les modérateurs pour vous surveiller."}',	2);
INSERT INTO "cms_pages" ("id", "title", "slug", "home", "is_parent", "parent_id", "p_view", "p_edit", "content", "type", "type_data", "state", "header", "header_data", "position") VALUES (14,	'Nouveautés',	'nouveautes',	'0',	'0',	'0',	'0',	2,	'',	'plugin',	'blog',	'0',	'simple_header',	'{"desc": "Toutes les dernières nouvelles du serveur"}',	2);
...
INSERT INTO "cms_sidebars" ("id", "name", "plugin", "position", "data") VALUES (1,	'Status du serveur',	'server_status',	1,	'{"ip": "play.onecraft.net", "port": "25565"}');
INSERT INTO "cms_sidebars" ("id", "name", "plugin", "position", "data") VALUES (2,	'TeamSpeak 3',	'teamspeak_connect',	2,	'{"address": "ts.onecraft.net"}');
...
INSERT INTO "cms_users" ("id", "username", "password", "email", "date_creation", "permission", "picture_url") VALUES (1,	'admin',	'515b0a7f27833a052a4e3385b1787cbe70c9a868347cae9fe5cc836defdd0294',	'contact@onecraft.net',	1408459504,	9,	'http://icons.iconarchive.com/icons/chrisl21/minecraft/256/Tnt-icon.png');
INSERT INTO "cms_users" ("id", "username", "password", "email", "date_creation", "permission", "picture_url") VALUES (2,	'Notch',	'9d98b2bc87f494c024603d2be437c43046c3f3fa5bc7388e0812947567629323',	'notch@minecraft.net',	1408836614,	1,	'http://www.appsfuze.com/static/images/apps/a/b/a/aba976f6-fb8e-e011-986b-78e7d1fa76f8.png');
INSERT INTO "cms_users" ("id", "username", "password", "email", "date_creation", "permission", "picture_url") VALUES (3,	'jeb_',	'9d98b2bc87f494c024603d2be437c43046c3f3fa5bc7388e0812947567629323',	'jeb_@minecraft.net',	1411849545,	1,	'http://www.poweredbyredstone.net/wp-content/uploads/2012/07/jeb_twitter_reasonably_small.jpg');
...
INSERT INTO "plugin_blog_comments" ("id", "type", "author_id", "post_id", "content", "state", "date") VALUES (2,	'comment',	2,	3,	'Très bon article, bien rédigé, bravo à l''auteur !',	'0',	1411942284);
INSERT INTO "plugin_blog_comments" ("id", "type", "author_id", "post_id", "content", "state", "date") VALUES (3,	'comment',	3,	2,	'Darude - Sandstorm',	'0',	1411942347);
